...
A skill for making x402 payments on Base that can be funded from most blockchains and financial applications like Cash App, Revolut, and Robinhood. Designed to work across most agent frameworks (Claude Code, OpenClaw, etc.) and to be compatible with multiple agent wallet setups.
